                            ...
                            @csrf
                               <div class="border border-3 p-4 rounded borderRmv">
                               	...
                               	<div class="mb-3">
                                    ...
                                    <input type="file" name="image" required class="form-control" id="img" placeholder="Enter emp image">
                                  </div>

                                  <div class="mb-3">
                                    <label for="inputProductTitle" class="form-label">emp_name</label>
                                    <input type="text" name="emp_name" required class="form-control" id="name" placeholder="Enter emp_name">
                                  </div>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <input type="text" name="designation" required class="form-control" id="designation" placeholder="Enter designation">
                                  </div>
