        ...
        <div class="page-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <p class="section-title-white">Once delete, the data could not be restored or recovered are you
                                sure you want to delete your account?</p>
                            <button class="btn btn-danger p-2 rounded-2">Delete Account</button>
                        </div>
